...
public class Suit {
	...
	/**
	 * Creates an unmodifiable list of Suit Types Can traverse this list using
	 * an iterator
	 */
	public final static List VALUES = Collections.unmodifiableList(Arrays
			.asList(new Suit[] { DIAMONDS, CLUBS, HEARTS, SPADES }));
