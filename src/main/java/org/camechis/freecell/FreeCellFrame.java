...
public class FreeCellFrame extends JFrame {
	...
	public boolean CheckMove(CardPanel movetopanel) {
		...
		// checks to see if its one of the free cells (only one card can be
		// stored here)
		if ((movetopanel.getID().equals("top1"))
				|| (movetopanel.getID().equals("top2"))
				|| (movetopanel.getID().equals("top3"))
		...
		if ((movetopanel.getID().equals("top5"))
				|| (movetopanel.getID().equals("top6"))
				|| (movetopanel.getID().equals("top7"))
			...
			if (movetopanel.isEmpty()) {
				...
				if ((firstclicked.getTopCardVal() == movetopanel
						.getTopCardVal() + 1)
						&& (firstclicked.getTopCardSuit().equals(movetopanel
								.getTopCardSuit()))) {
					return true;
				} else
					return false;
		...
		// check bottom stack movements
			...
			if (movetopanel.isEmpty() == true)
				...
				return false;
			else if ((firstclicked.getTopCardVal() == movetopanel
					.getTopCardVal() - 1)
					&& ((!firstclicked.getTopCardColor().equals(
							movetopanel.getTopCardColor()))))
				return true;
			else
				return false;
		}
	...
	public void checkWin() {
		if ((top5.getTopCardVal() == 13) && (top6.getTopCardVal() == 13)
				&& (top7.getTopCardVal() == 13) && (top8.getTopCardVal() == 13)) {
